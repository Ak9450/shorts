...
Pod::Spec.new do |s|
  s.name             = 'Shorts'
  s.version          = '0.1.0'
  s.summary          = 'A short description of Shorts.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/24208369/Shorts'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '24208369' => 'akash.tr.98@gmail.com' }
  s.source           = { :git => 'https://github.com/24208369/Shorts.git', :tag => s.version.to_s }
